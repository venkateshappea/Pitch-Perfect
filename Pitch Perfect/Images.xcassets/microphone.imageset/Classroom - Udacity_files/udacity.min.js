...
c).then(function(a){return a.data.certificates})},checkIfJabberIdIsStaff:function(a){return d.get("/users/account_for_jabber_id/"+encodeURIComponent(a)).then(function(a){if(a=a.data.user._memberships)return 0<_.filter(a,function(a){return-1<a.group_ref.key.indexOf("staff")}).length})},setFinalStepsEmailSent:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"final_steps_email_sent",tag:c}]})},checkIfFirstChatVisit:function(a){return d.get("/users/"+a+"/tags",{namespace:"chat",
tag:"introtochatseen"})},setFirstChatVisit:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"chat",tag:"introtochatseen"}]})},checkNewHomeBanner:function(a){return d.get("/users/"+a+"/tags",{namespace:"showNotificationBanner",tag:"hidden"})},setNewHomeBanner:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"showNotificationBanner",tag:"hidden"}]})},setAddToCalFlag:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",
namespace:"showAddToCalBanner",tag:c}]})},setOnboardingFlag:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"ndonboarding",tag:c}]})},getTags:function(){return d.get("/users/me/tags")},getStudyGroups:function(a){return d.get("/study_groups/get_for_user/"+a).then(function(a){return a.data.groups})},fetchJWTForLayer:function(a){return d.post("/session/chat/jwt",{nonce:a}).then(function(a){return a.data.identity_token})},addToEmailList:function(a,c,e,f){a={email_address:c,
user_name:a,list_name:e};f&&(a.data=f);return d.post("/users/join_email_list",a)},getSignatureUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+"/signature/upload_url").then(function(a){return a.data.url})},getImageUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+"/image/upload_url").then(function(a){return a.data.url})},getTutors:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/tutors",c).then(function(a){return a.data})},getTutees:function(a,c){return d.get("/users/"+
...
productCurrency:e.product.currency,productPrice:e.product.amount,orderNodeKey:e.course.key,isNanodegree:a.isNanodegree,isCareer:a.isCareer,getCourseType:a.getCourseType})});b=e.product.trial_period_days;e.inTrialPeriod=0<b;e.trialPeriodStarts=new Date(Date.now()+b*m);e.customer=a[1];e.customerCard=d.getDefaultCard(e.customer);e.cardIsLoaded=!0;e.uriEncodedCourseKey=window.encodeURIComponent(t(e.product))})},onJump:function(a){return a.paymentConfirmed?!1:!a.paymentConfirmed},onSubmit:function(b,c){if(c.customerCard)return w(!1,
